...
def main():
    ...
    schedule.every().day.at("16:42:30").do(get_summary,"")
    schedule.every().day.at("16:42:50").do(upload_to_sharepoint,"")
    ...
    #schedule.every().day.at("07:15:30").do(get_summary,"")
    #schedule.every().day.at("07:15:50").do(upload_to_sharepoint,"")
